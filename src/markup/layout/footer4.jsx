    ...
    return (
        <>
            <footer className="site-footer">
                <div className="footer-top" style={{ backgroundImage: "url(" + bg + ")" }}>
                                        ...
                                        <form className="dzSubscribe" ref={form} onSubmit={sendEmail}>
                                            ...
                                            <div className="input-group">
                                                ...
                                                <span className="input-group-btn">
                                                    <button name="submit" value="Submit" type="submit" className="site-button radius-xl btnhover16">Subscribe</button>
                                                </span> 
                                            </div>
                                        </form>
                                    </div>
