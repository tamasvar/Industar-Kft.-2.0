                            ...
                            <div className="container clearfix">
                                ...
                                <div className="header-nav navbar-collapse collapse justify-content-start" id="navbarNavDropdown">
                                    <div className="logo-header d-md-block d-lg-none">
                                        <Link to="/"><img src={require("../../images/logo-5.png")} alt=""/></Link>
                                    </div>
                                    ...
                                    <div className="dlab-social-icon ind-social">
                                        <ul>
                                            <li><Link className="site-button-link facebook fa fa-facebook" to="/javascript:void(0);"></Link></li>
                                            <li><Link className="site-button-link twitter fa fa-twitter" to="/javascript:void(0);"></Link></li>
                                            <li><Link className="site-button-link linkedin fa fa-linkedin" to="/javascript:void(0);"></Link></li>
                                            <li><Link className="site-button-link instagram fa fa-instagram" to="/javascript:void(0);"></Link></li>
                                        </ul>
                                        <p>2019 Industry</p>
                                    </div>
                                </div>
