...
const Footer14 = () => {
    ...
    return (
        <>
            <footer className="site-footer footer-gray-1" id="footer">
                                        ...
                                        <form className="dzSubscribe" onSubmit={sendEmail}>
                                            ...
                                            <div className="input-group">
                                                ...
                                                <span className="input-group-btn">
                                                    <button name="submit" value="Submit" type="submit" className="site-button btnhover19 radius-no">SEND</button>
                                                </span> 
                                            </div>
                                        </form>
                                    </div>
