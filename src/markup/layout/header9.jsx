...
class Header9 extends Component {
    ...
    render() {
        ...
        return (
            <>
            <header className="site-header header-transparent header-white-transparent  mo-left header navstyle1" >
                    ...
                    <div className="container">
                        <div className="row d-flex justify-content-between align-items-center">
                            ...
                            <div className="dlab-topbar-right">
                                <Link to="/contact-1" className="site-button btnhover17 radius-no">GET A QUOTE</Link>						
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <div className="container clearfix">
                                ...
                                <div className="header-nav navbar-collapse collapse justify-content-end" id="navbarNavDropdown">
                                    ...
                                    <div className="dlab-social-icon">
                                        <ul>
                                            <li><Link className="site-button sharp facebook fa fa-facebook" to="#"></Link></li>
                                            <li><Link className="site-button sharp twitter fa fa-twitter" to="#"></Link></li>
                                            <li><Link className="site-button sharp linkedin fa fa-linkedin" to="#"></Link></li>
                                            <li><Link className="site-button sharp instagram fa fa-instagram" to="#"></Link></li>
                                        </ul>
                                    </div>						
                                </div>
                            </div>
