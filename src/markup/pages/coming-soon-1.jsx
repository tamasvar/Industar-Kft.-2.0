...
class ComingSoon1 extends Component {
    ...
    render() {
        return (
            <>
            <div id="rev_slider_152_1_wrapper" className="rev_slider_wrapper fullscreen-container" data-alias="coming-soon" data-source="gallery" style={{backgroundColor:"#222222",padding:"0px"}}>
                <div id="rev_slider_152_1" className="rev_slider fullscreenbanner" style={{display:"none"}} data-version="5.4.1">
                    <ul>
                        <li data-index="rs-414" data-transition="fade" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off"  data-easein="default" data-easeout="default" data-masterspeed="300"  data-rotate="0"  data-saveperformance="off"  data-title="Slide" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
                            <img src={require("../../images/background/cs.jpg")}  alt=""  data-bgposition="center center" data-kenburns="on" data-duration="20000" data-ease="Linear.easeNone" data-scalestart="130" data-scaleend="100" data-rotatestart="0" data-rotateend="0" data-offsetstart="0 0" data-offsetend="0 0" className="rev-slidebg" data-no-retina/>
                            <div className="tp-caption   tp-resizeme" 
                                ...
                                style={{zIndex:"5",whiteSpace:"nowrap",fontSize:"30px",lineHeight:"30px",fontWeight:"500",color:"rgba(255,255, 255, 1.00)",fontFamily:"Poppins"}}>Industry
                            </div>
                            ...
                            <div className="tp-caption   tp-resizeme" 
                                ...
                                style={{zIndex:"6",whiteSpace:"nowrap",fontSize:"100px",lineHeight:"100px",fontWeight:"700",color:"rgba(255, 255, 255, 1.00)",fontFamily:"Poppins",letterSpacing:"-5px"}}>LAUNCHING 
                            </div>
                            ...
                            <div className="tp-caption   tp-resizeme" 
                                ...
                                style={{zIndex:"7",whiteSpace:"nowrap",fontSize:"100px",lineHeight:"100px",fontWeight:"300",color:"rgba(255, 255, 255, 1.00)",fontFamily:"Poppins",letterSpacing:"-5px"}}>VERY SOON. 
                            </div>
                            ...
                            <div className="tp-caption   tp-resizeme" 
                                ...
                                style={{zIndex:"8",minWidth:"300px",maxWidth:"300px",whiteSpace:"nowrap",fontSize:"200px",lineHeight:"200px",fontWeight:"600",color:"#ff5e14",fontFamily:"Poppins",letterSpacing:"-5px"}} 
                                id="t_days">00 
                            </div>
                            ...
                            <div className="tp-caption   tp-resizeme" 
                                ...
                                style={{zIndex:"9",minWidth:"300px",maxWidth:"300px",whiteSpace:"nowrap",fontSize:"200px",lineHeight:"200px",fontWeight:"600",color:"#ff5e14",fontFamily:"Poppins",letterSpacing:"-5px"}} 
                                id="t_hourss">00 
                            </div>
                            ...
                            <div className="tp-caption   tp-resizeme" 
                                ...
                                style={{zIndex:"10",minWidth:"300px",maxWidth:"300px",whiteSpace:"nowrap",fontSize:"200px",lineHeight:"200px",fontWeight:"600",color:"#ff5e14",fontFamily:"Poppins",letterSpacing:"-5px"}} 
                                id="t_minutes">00 
                            </div>
                            ...
                            <div className="tp-caption   tp-resizeme" 
                                ...
                                style={{zIndex:"11",minWidth:"300px",maxWidth:"300px",whiteSpace:"nowrap",fontSize:"200px",lineHeight:"200px",fontWeight:"600",color:"#ff5e14",fontFamily:"Poppins",letterSpacing:"-5px"}} 
                                id="t_seconds">00 
                            </div>
                            ...
                            <div className="tp-caption   tp-resizeme" 
                                ...
                                style={{zIndex:"12",minWidth:"300px",maxWidth:"300px",whiteSpace:"nowrap",fontSize:"25px",lineHeight:"25px",fontWeight:"600",color:"rgba(255, 255, 255, 1.00)",fontFamily:"Poppins"}}>DAYS
                            </div>
                            ...
                            <div className="tp-caption   tp-resizeme" 
                                ...
                                style={{zIndex:"13",minWidth:"300px",maxWidth:"300px",whiteSpace:"nowrap",fontSize:"25px",lineHeight:"25px",fontWeight:"600",color:"rgba(255, 255, 255, 1.00)",fontFamily:"Poppins"}}>HOURS
                            </div>
                            ...
                            <div className="tp-caption   tp-resizeme" 
                                ...
                                style={{zIndex:"14",minWidth:"300px",maxWidth:"300px",whiteSpace:"nowrap",fontSize:"25px",lineHeight:"25px",fontWeight:"600",color:"rgba(255, 255, 255, 1.00)",fontFamily:"Poppins"}}>MINUTES 
                            </div>
                            ...
                            <div className="tp-caption   tp-resizeme" 
                                ...
                                style={{zIndex:"15",minWidth:"300px",maxWidth:"300px",whiteSpace:"nowrap",fontSize:"25px",lineHeight:"25px",fontWeight:"600",color:"rgba(255, 255, 255, 1.00)",fontFamily:"Poppins"}}>SECONDS 
                            </div>
                            
                            <Link className="tp-caption tp-resizeme" target="_blank" to="#" id="slide-414-layer-16" 
                                data-x="['left','left','left','left']" data-hoffset="['100','50','50','30']" 
                                ...
                                style={{zIndex:"16",minWidth:"60px",maxWidth:"60px",whiteSpace:"nowrap",fontSize:"20px",lineHeight:"60px",fontWeight:"400",color:"rgba(255, 255, 255, 1.00)",fontFamily:"Open Sans",borderColor:"rgba(255, 255, 255, 1.00)",borderStyle:"solid",borderWidth:"2px 2px 2px 2px",borderRadius:"50% 50% 50% 50%",cursor:"pointer"}}><i className="fa fa-facebook"></i> </Link>
                                
                            
                            <Link className="tp-caption tp-resizeme" target="_blank" to="#" id="slide-414-layer-17" 
                                ...
                                style={{zIndex:"17",minWidth:"60px",maxWidth:"60px",whiteSpace:"nowrap",fontSize:"20px",lineHeight:"60px",fontWeight:"400",color:"rgba(255, 255, 255, 1.00)",fontFamily:"Open Sans",borderColor:"rgba(255, 255, 255, 1.00)",borderStyle:"solid",borderWidth:"2px 2px 2px 2px",borderRadius:"50% 50% 50% 50%",cursor:"pointer"}}><i className="fa  fa-twitter"></i> </Link>

                            
                            <Link className="tp-caption tp-resizeme" target="_blank" to="#" id="slide-414-layer-18" 
                                ...
                                style={{zIndex:"18",fontSize:"20px",lineHeight:"60px",fontWeight:"400",width:"60px",height:"60px",color:"rgba(255, 255, 255, 1.00)",fontFamily:"Open Sans",border:"2px solid rgba(255, 255, 255, 1.00)",borderRadius:"50%"}}><i className="fa fa-google-plus"></i> </Link>
                        </li>
                    </ul>
